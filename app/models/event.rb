class Event < ActiveRecord::Base
  attr_accessible :title, :description, :website, :image, :price, :url, :tag_list, :sitecity_id, :enddatetime, :startdatetime, :location, :street1, :street2, :city, :postalcode, :email, :phone, :location_id, :organizer_id
